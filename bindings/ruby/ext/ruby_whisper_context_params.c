...
#define DEF_BOOLEAN_ATTR_METHOD(name)                                                                                  \
    static VALUE ruby_whisper_context_params_get_##name(VALUE self) {                                                  \
        ruby_whisper_context_params* rwcp;                                                                             \
        GetContextParams(self, rwcp);                                                                                  \
        return rwcp->params.name ? Qtrue : Qfalse;                                                                     \
    }                                                                                                                  \
    static VALUE ruby_whisper_context_params_set_##name(VALUE self, VALUE value) {                                     \
        ruby_whisper_context_params* rwcp;                                                                             \
        GetContextParams(self, rwcp);                                                                                  \
...
static size_t ruby_whisper_context_params_memsize(const void* p) {
...
const rb_data_type_t ruby_whisper_context_params_type = {"ruby_whisper_context_params",
                                                         {
                                                             0,
                                                             RUBY_DEFAULT_FREE,
                                                             ruby_whisper_context_params_memsize,
                                                         },
                                                         0,
                                                         0,
                                                         0};

static VALUE ruby_whisper_context_params_s_allocate(VALUE klass) {
    ruby_whisper_context_params* rwcp;
...
static VALUE ruby_whisper_context_params_get_dtw_n_top(VALUE self) {
    ruby_whisper_context_params* rwcp;
    GetContextParams(self, rwcp);
...
static VALUE ruby_whisper_context_params_set_dtw_n_top(VALUE self, VALUE value) {
    ruby_whisper_context_params* rwcp;
    GetContextParams(self, rwcp);
...
static VALUE ruby_whisper_context_params_initialize(int argc, VALUE* argv, VALUE self) {
    ruby_whisper_context_params* rwcp;
...
void init_ruby_whisper_context_params(VALUE* cContext) {
