...
static size_t ruby_whisper_token_memsize(const void* p) {
...
static void ruby_whisper_token_mark(void* p) {
    ruby_whisper_token* rwt = (ruby_whisper_token*)p;
    rb_gc_mark(rwt->text);
}

static void ruby_whisper_token_free(void* p) {
    ruby_whisper_token* rwt = (ruby_whisper_token*)p;
    if (rwt->token_data) {
...
static const rb_data_type_t ruby_whisper_token_type = {"ruby_whisper_token",
                                                       {
                                                           ruby_whisper_token_mark,
                                                           ruby_whisper_token_free,
                                                           ruby_whisper_token_memsize,
                                                       },
                                                       0,
                                                       0,
                                                       0};

static VALUE ruby_whisper_token_allocate(VALUE klass) {
 ...
 *   id -> Integer
 */
static VALUE ruby_whisper_token_get_id(VALUE self) {
    ruby_whisper_token* rwt;
    GetToken(self, rwt);
 ...
 *   tid -> Integer
 */
static VALUE ruby_whisper_token_get_tid(VALUE self) {
    ruby_whisper_token* rwt;
    GetToken(self, rwt);
 ...
 *   probability -> Float
 */
static VALUE ruby_whisper_token_get_p(VALUE self) {
    ruby_whisper_token* rwt;
    GetToken(self, rwt);
 ...
 */
static VALUE ruby_whisper_token_get_plog(VALUE self) {
    ruby_whisper_token* rwt;
    GetToken(self, rwt);
 ...
 *   pt -> Float
 */
static VALUE ruby_whisper_token_get_pt(VALUE self) {
    ruby_whisper_token* rwt;
    GetToken(self, rwt);
 ...
 *   ptsum -> Float
 */
static VALUE ruby_whisper_token_get_ptsum(VALUE self) {
    ruby_whisper_token* rwt;
    GetToken(self, rwt);
 ...
 *   t_dtw -> Integer
 */
static VALUE ruby_whisper_token_get_t_dtw(VALUE self) {
    ruby_whisper_token* rwt;
    GetToken(self, rwt);
 ...
 *   voice_length -> Float
 */
static VALUE ruby_whisper_token_get_vlen(VALUE self) {
    ruby_whisper_token* rwt;
    GetToken(self, rwt);
 ...
 *   text -> String
 */
static VALUE ruby_whisper_token_get_text(VALUE self) {
    ruby_whisper_token* rwt;
    GetToken(self, rwt);
    return rwt->text;
}
 ...
 *   start_time -> Integer
 */
static VALUE ruby_whisper_token_get_start_time(VALUE self) {
    ruby_whisper_token* rwt;
    GetToken(self, rwt);
 ...
 *   end_time -> Integer
 */
static VALUE ruby_whisper_token_get_end_time(VALUE self) {
    ruby_whisper_token* rwt;
    GetToken(self, rwt);
...
static VALUE ruby_whisper_token_deconstruct_keys(VALUE self, VALUE keys) {
    ...
    if (NIL_P(keys)) {
        keys = rb_ary_new3(N_KEY_NAMES, sym_id, sym_tid, sym_probability, sym_log_probability, sym_pt, sym_ptsum,
                           sym_t_dtw, sym_voice_length, sym_start_time, sym_end_time, sym_text);
        n_keys = N_KEY_NAMES;
    } else {
...
void init_ruby_whisper_token(VALUE* mWhisper) {
