...
static size_t ruby_whisper_vad_segments_memsize(const void* p) {
...
static void ruby_whisper_vad_segments_free(void* p) {
...
const rb_data_type_t ruby_whisper_vad_segments_type = {"ruby_whisper_vad_segments",
                                                       {
                                                           0,
                                                           ruby_whisper_vad_segments_free,
                                                           ruby_whisper_vad_segments_memsize,
                                                       },
                                                       0,
                                                       0,
                                                       0};

static VALUE ruby_whisper_vad_segments_s_allocate(VALUE klass) {
...
static VALUE ruby_whisper_vad_segments_each(VALUE self) {
    ruby_whisper_vad_segments* rwvss;
    VALUE method_name;
    int n_segments, i;
...
static VALUE ruby_whisper_vad_segments_get_length(VALUE self) {
    ruby_whisper_vad_segments* rwvss;
    int n_segments;
...
void init_ruby_whisper_vad_segments(VALUE* mVAD) {
