...
static size_t ruby_whisper_vad_params_memsize(const void* p) {
...
const rb_data_type_t ruby_whisper_vad_params_type = {"ruby_whisper_vad_params",
                                                     {
                                                         0,
                                                         0,
                                                         ruby_whisper_vad_params_memsize,
                                                     },
                                                     0,
                                                     0,
                                                     0};

static VALUE ruby_whisper_vad_params_s_allocate(VALUE klass) {
 ...
 *   threshold = th -> th
 */
static VALUE ruby_whisper_vad_params_set_threshold(VALUE self, VALUE value) {
    ruby_whisper_vad_params* rwvp;
...
static VALUE ruby_whisper_vad_params_get_threshold(VALUE self) {
    ruby_whisper_vad_params* rwvp;
    TypedData_Get_Struct(self, ruby_whisper_vad_params, &ruby_whisper_vad_params_type, rwvp);
 ...
 */
static VALUE ruby_whisper_vad_params_set_min_speech_duration_ms(VALUE self, VALUE value) {
    ruby_whisper_vad_params* rwvp;
    TypedData_Get_Struct(self, ruby_whisper_vad_params, &ruby_whisper_vad_params_type, rwvp);
...
static VALUE ruby_whisper_vad_params_get_min_speech_duration_ms(VALUE self) {
    ruby_whisper_vad_params* rwvp;
    TypedData_Get_Struct(self, ruby_whisper_vad_params, &ruby_whisper_vad_params_type, rwvp);
 ...
 */
static VALUE ruby_whisper_vad_params_set_min_silence_duration_ms(VALUE self, VALUE value) {
    ruby_whisper_vad_params* rwvp;
    TypedData_Get_Struct(self, ruby_whisper_vad_params, &ruby_whisper_vad_params_type, rwvp);
...
static VALUE ruby_whisper_vad_params_get_min_silence_duration_ms(VALUE self) {
    ruby_whisper_vad_params* rwvp;
    TypedData_Get_Struct(self, ruby_whisper_vad_params, &ruby_whisper_vad_params_type, rwvp);
 ...
 */
static VALUE ruby_whisper_vad_params_set_max_speech_duration_s(VALUE self, VALUE value) {
    ruby_whisper_vad_params* rwvp;
    TypedData_Get_Struct(self, ruby_whisper_vad_params, &ruby_whisper_vad_params_type, rwvp);
...
static VALUE ruby_whisper_vad_params_get_max_speech_duration_s(VALUE self) {
    ruby_whisper_vad_params* rwvp;
    TypedData_Get_Struct(self, ruby_whisper_vad_params, &ruby_whisper_vad_params_type, rwvp);
 ...
 */
static VALUE ruby_whisper_vad_params_set_speech_pad_ms(VALUE self, VALUE value) {
    ruby_whisper_vad_params* rwvp;
    TypedData_Get_Struct(self, ruby_whisper_vad_params, &ruby_whisper_vad_params_type, rwvp);
...
static VALUE ruby_whisper_vad_params_get_speech_pad_ms(VALUE self) {
    ruby_whisper_vad_params* rwvp;
    TypedData_Get_Struct(self, ruby_whisper_vad_params, &ruby_whisper_vad_params_type, rwvp);
 ...
 */
static VALUE ruby_whisper_vad_params_set_samples_overlap(VALUE self, VALUE value) {
    ruby_whisper_vad_params* rwvp;
    TypedData_Get_Struct(self, ruby_whisper_vad_params, &ruby_whisper_vad_params_type, rwvp);
...
static VALUE ruby_whisper_vad_params_get_samples_overlap(VALUE self) {
    ruby_whisper_vad_params* rwvp;
    TypedData_Get_Struct(self, ruby_whisper_vad_params, &ruby_whisper_vad_params_type, rwvp);
    return DBL2NUM(rwvp->params.samples_overlap);
}

static VALUE ruby_whisper_vad_params_equal(VALUE self, VALUE other) {
...
void init_ruby_whisper_vad_params(VALUE* mVAD) {
