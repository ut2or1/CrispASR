...
| vibevoice-streaming (ASR) | ✓ | ✓ | ✓ | ✓ | Q4_K is validated against the persistent-stream F16 path; set `CRISPASR_VIBEVOICE_ASR_FRONTEND_F16=1` while quantizing to keep the encoder frontend in F16 for an A/B arm. |
