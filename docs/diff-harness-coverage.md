...
Auto-generated by `tools/audit_diff_coverage.py` on 2026-08-30. Do
not edit by hand — re-run the tool to refresh.

- 72 registered reference backends
- 0 have a frozen reference archive on disk
- 62 have a `crispasr-diff` C++ harness branch
- **0 are fully wired** (archive + harness branch)
- 72 have at least one gap
...
| `basic_pitch` | `tools/reference_backends/basic_pitch.py` | — | — | yes | gguf, librosa, onnxruntime, scipy |
...
| `nemotron` | `tools/reference_backends/nemotron.py` | — | — | yes | nemo, torch |
...
- `basic_pitch` — `tools/bootstrap_ref_env.sh basic_pitch` then `python tools/dump_reference.py --backend basic_pitch --model-dir <dir> --audio samples/jfk.wav --output /Volumes/backups/ai/basic_pitch-ref.gguf`
