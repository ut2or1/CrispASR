A sample Android app using Java code and [CrispASR](https://github.com/CrispStrobe/CrispASR) to do voice-to-text transcriptions.
...
3. If you want to import a compiled cpp project in your Android project, please refer to the https://github.com/litongjava/crispasr.android.java.demo  
