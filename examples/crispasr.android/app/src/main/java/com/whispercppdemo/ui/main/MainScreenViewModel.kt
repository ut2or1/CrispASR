package com.crispasr.demo.ui.main
...
import com.crispasr.demo.media.decodeWaveFile
import com.crispasr.demo.recorder.Recorder
import com.crispasr.whisper.WhisperContext
...
class MainScreenViewModel(private val application: Application) : ViewModel() {
    ...
    private var whisperContext: com.crispasr.whisper.WhisperContext? = null
    ...
    private suspend fun printSystemInfo() {
        printMessage(String.format("System Info: %s\n", com.crispasr.whisper.WhisperContext.getSystemInfo()))
    }
    ...
    private suspend fun loadBaseModel() = withContext(Dispatchers.IO) {
        ...
        if (models != null) {
            whisperContext = com.crispasr.whisper.WhisperContext.createContextFromAsset(application.assets, "models/" + models[0])
