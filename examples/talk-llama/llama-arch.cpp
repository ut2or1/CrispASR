...
static std::set<llm_tensor> llm_get_tensor_names(llm_arch arch) {
    ...
    case LLM_ARCH_AFMOE:
        return {
            ...
            LLM_TENSOR_ATTN_OUT,        LLM_TENSOR_ATTN_Q_NORM,    LLM_TENSOR_ATTN_K_NORM,   LLM_TENSOR_ATTN_GATE,
            LLM_TENSOR_FFN_NORM,        LLM_TENSOR_FFN_POST_NORM,  LLM_TENSOR_FFN_GATE_INP,  LLM_TENSOR_FFN_GATE,
            LLM_TENSOR_FFN_DOWN,        LLM_TENSOR_FFN_UP,         LLM_TENSOR_FFN_GATE_EXPS, LLM_TENSOR_FFN_DOWN_EXPS,
            LLM_TENSOR_FFN_UP_EXPS,     LLM_TENSOR_FFN_GATE_SHEXP, LLM_TENSOR_FFN_UP_SHEXP,  LLM_TENSOR_FFN_DOWN_SHEXP,
    ...
    case LLM_ARCH_STARCODER:
        return {
            LLM_TENSOR_TOKEN_EMBD, LLM_TENSOR_POS_EMBD, LLM_TENSOR_OUTPUT_NORM, LLM_TENSOR_OUTPUT, LLM_TENSOR_ATTN_NORM,
            LLM_TENSOR_ATTN_QKV,   LLM_TENSOR_ATTN_OUT, LLM_TENSOR_FFN_NORM,    LLM_TENSOR_FFN_UP, LLM_TENSOR_FFN_DOWN,
        };
    ...
    case LLM_ARCH_EUROBERT:
        return {
            ...
            LLM_TENSOR_FFN_GATE,   LLM_TENSOR_FFN_UP,      LLM_TENSOR_FFN_DOWN,
        };
    case LLM_ARCH_MODERN_BERT:
        return {
            ...
            LLM_TENSOR_CLS,        LLM_TENSOR_CLS_OUT,         LLM_TENSOR_CLS_NORM,
        };
    ...
    case LLM_ARCH_COHERE2:
        return {
            LLM_TENSOR_TOKEN_EMBD, LLM_TENSOR_OUTPUT_NORM, LLM_TENSOR_ATTN_NORM, LLM_TENSOR_ATTN_Q,   LLM_TENSOR_ATTN_K,
            LLM_TENSOR_ATTN_V,     LLM_TENSOR_ATTN_OUT,    LLM_TENSOR_FFN_GATE,  LLM_TENSOR_FFN_DOWN, LLM_TENSOR_FFN_UP,
        };
    case LLM_ARCH_DBRX:
        return {
    ...
    case LLM_ARCH_DEEPSEEK2:
        return {
            ...
            LLM_TENSOR_ATTN_Q,          LLM_TENSOR_ATTN_Q_A,         LLM_TENSOR_ATTN_Q_B,
            LLM_TENSOR_ATTN_KV_A_MQA,   LLM_TENSOR_ATTN_KV_B,        LLM_TENSOR_ATTN_K_B,
            LLM_TENSOR_ATTN_V_B,        LLM_TENSOR_ATTN_OUT,         LLM_TENSOR_FFN_NORM,
            LLM_TENSOR_FFN_GATE,        LLM_TENSOR_FFN_UP,           LLM_TENSOR_FFN_DOWN,
            LLM_TENSOR_FFN_GATE_INP,    LLM_TENSOR_FFN_GATE_EXPS,    LLM_TENSOR_FFN_DOWN_EXPS,
            LLM_TENSOR_FFN_UP_EXPS,     LLM_TENSOR_FFN_GATE_UP_EXPS, LLM_TENSOR_FFN_GATE_INP_SHEXP,
    ...
    case LLM_ARCH_T5ENCODER:
        return {
            LLM_TENSOR_TOKEN_EMBD,     LLM_TENSOR_OUTPUT,       LLM_TENSOR_ENC_OUTPUT_NORM, LLM_TENSOR_ENC_ATTN_NORM,
            LLM_TENSOR_ENC_ATTN_Q,     LLM_TENSOR_ENC_ATTN_K,   LLM_TENSOR_ENC_ATTN_V,      LLM_TENSOR_ENC_ATTN_OUT,
            LLM_TENSOR_ENC_ATTN_REL_B, LLM_TENSOR_ENC_FFN_NORM, LLM_TENSOR_ENC_FFN_GATE,    LLM_TENSOR_ENC_FFN_DOWN,
            LLM_TENSOR_ENC_FFN_UP,
        };
    case LLM_ARCH_JAIS:
        return {
            LLM_TENSOR_TOKEN_EMBD, LLM_TENSOR_OUTPUT_NORM, LLM_TENSOR_OUTPUT, LLM_TENSOR_ATTN_NORM, LLM_TENSOR_ATTN_QKV,
            LLM_TENSOR_ATTN_OUT,   LLM_TENSOR_FFN_NORM,    LLM_TENSOR_FFN_UP, LLM_TENSOR_FFN_GATE,  LLM_TENSOR_FFN_DOWN,
        };
    case LLM_ARCH_JAIS2:
        return {
            LLM_TENSOR_TOKEN_EMBD, LLM_TENSOR_OUTPUT_NORM, LLM_TENSOR_OUTPUT,   LLM_TENSOR_ATTN_NORM,
            LLM_TENSOR_ATTN_Q,     LLM_TENSOR_ATTN_K,      LLM_TENSOR_ATTN_V,   LLM_TENSOR_ATTN_OUT,
            LLM_TENSOR_FFN_NORM,   LLM_TENSOR_FFN_UP,      LLM_TENSOR_FFN_DOWN,
        };
    case LLM_ARCH_NEMOTRON_H:
        return {
            LLM_TENSOR_TOKEN_EMBD, LLM_TENSOR_OUTPUT_NORM, LLM_TENSOR_OUTPUT, LLM_TENSOR_ATTN_NORM, LLM_TENSOR_SSM_IN,
            LLM_TENSOR_SSM_CONV1D, LLM_TENSOR_SSM_DT,      LLM_TENSOR_SSM_A,  LLM_TENSOR_SSM_D,     LLM_TENSOR_SSM_NORM,
            LLM_TENSOR_SSM_OUT,    LLM_TENSOR_ATTN_Q,      LLM_TENSOR_ATTN_K, LLM_TENSOR_ATTN_V,    LLM_TENSOR_ATTN_OUT,
            LLM_TENSOR_FFN_DOWN,   LLM_TENSOR_FFN_UP,
        };
    ...
    case LLM_ARCH_ERNIE4_5_MOE:
        return {
            ...
            LLM_TENSOR_ATTN_Q,        LLM_TENSOR_ATTN_K,         LLM_TENSOR_ATTN_V,         LLM_TENSOR_ATTN_OUT,
            LLM_TENSOR_FFN_NORM,      LLM_TENSOR_FFN_GATE,       LLM_TENSOR_FFN_DOWN,       LLM_TENSOR_FFN_UP,
            LLM_TENSOR_FFN_GATE_INP,  LLM_TENSOR_FFN_GATE_SHEXP, LLM_TENSOR_FFN_DOWN_SHEXP, LLM_TENSOR_FFN_UP_SHEXP,
    ...
    case LLM_ARCH_GROVEMOE:
        return {
            ...
            LLM_TENSOR_ATTN_Q,          LLM_TENSOR_ATTN_Q_NORM,   LLM_TENSOR_ATTN_K,      LLM_TENSOR_ATTN_K_NORM,
            LLM_TENSOR_ATTN_V,          LLM_TENSOR_ATTN_OUT,      LLM_TENSOR_FFN_NORM,    LLM_TENSOR_FFN_GATE_INP,
            LLM_TENSOR_FFN_GATE_EXPS,   LLM_TENSOR_FFN_DOWN_EXPS, LLM_TENSOR_FFN_UP_EXPS, LLM_TENSOR_FFN_GATE_CHEXPS,
            LLM_TENSOR_FFN_DOWN_CHEXPS, LLM_TENSOR_FFN_UP_CHEXPS,
        };
...
LLM_TN_IMPL::LLM_TN_IMPL(llm_arch arch, llm_tensor tensor, const char* suffix, int bid, int xid)
    : arch(arch), tensor(tensor), suffix(suffix), bid(bid), xid(xid), model_tensors(llm_get_tensor_names(arch)) {}
