...
public:
    llama_memory_hybrid_iswa(const llama_model& model,
                             /* attn */
...
public:
    ...
    // init update
    explicit llama_memory_hybrid_iswa_context(llama_memory_hybrid_iswa* mem, llama_context* lctx, bool optimize);

    // init success
    llama_memory_hybrid_iswa_context(llama_memory_hybrid_iswa* mem, slot_info_vec_t sinfos_base,
