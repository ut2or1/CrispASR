...
llm_build_qwen2moe::llm_build_qwen2moe(const llama_model& model, const llm_graph_params& params)
    ...
    for (int il = 0; il < n_layer; ++il) {
        ...
        ggml_tensor* moe_out = build_moe_ffn(cur, model.layers[il].ffn_gate_inp, model.layers[il].ffn_up_exps,
                                             ...
                                             n_expert, n_expert_used, LLM_FFN_SILU, false, hparams.expert_weights_scale,
