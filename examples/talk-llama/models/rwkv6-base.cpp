...
ggml_tensor* llm_build_rwkv6_base::build_rwkv6_channel_mix(const llama_layer* layer, ggml_tensor* cur,
...
ggml_tensor* llm_build_rwkv6_base::build_rwkv6_time_mix(llm_graph_input_rs* inp, ggml_tensor* cur, ggml_tensor* x_prev,
