...
llm_build_hunyuan_dense::llm_build_hunyuan_dense(const llama_model& model, const llm_graph_params& params)
    ...
    for (int il = 0; il < n_layer; ++il) {
        ...
        ggml_tensor* cur_mlp =
            build_ffn(cur, model.layers[il].ffn_up, NULL, NULL, model.layers[il].ffn_gate, NULL, NULL,
