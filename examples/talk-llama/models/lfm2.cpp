...
llm_build_lfm2<iswa>::llm_build_lfm2(const llama_model& model, const llm_graph_params& params)
    ...
    auto build_attn_block = [&model, this](ggml_tensor* cur, ggml_tensor* inp_pos, inp_attn_type* inp_attn,
                                           int il) -> ggml_tensor* {
    ...
    auto build_shortconv_block = [&model, this](ggml_tensor* cur, llm_graph_input_rs* inp_recr,
                                                int il) -> ggml_tensor* {
