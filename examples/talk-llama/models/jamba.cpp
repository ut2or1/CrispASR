...
llm_build_jamba::llm_build_jamba(const llama_model& model, const llm_graph_params& params)
    ...
    for (int il = 0; il < n_layer; ++il) {
        ...
        if (n_head_kv == 0) {
            ...
            // No RoPE :)
            cur = build_attn(inp_hybrid->get_attn(), model.layers[il].wo, NULL, Qcur, Kcur, Vcur, NULL, NULL, NULL,
        ...
        if (model.layers[il].ffn_gate_inp == nullptr) {
            ...
            cur = build_moe_ffn(cur, model.layers[il].ffn_gate_inp, model.layers[il].ffn_up_exps,
                                ...
                                n_expert_used, LLM_FFN_SILU, false, hparams.expert_weights_scale,
