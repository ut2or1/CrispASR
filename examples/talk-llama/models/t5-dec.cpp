...
llm_build_t5_dec::llm_build_t5_dec(const llama_model& model, const llm_graph_params& params)
    ...
    for (int il = 0; il < dec_n_layer; ++il) {
        ...
        // self-attention
        {
            ...
            cur = build_attn(inp_attn_self, model.layers[il].wo, model.layers[il].bo, Qcur, Kcur, Vcur, kq_b, nullptr,
                             nullptr, 1.0f, il);
            cb(cur, "kqv_out", il);
        }
        ...
        // cross-attention
        {
            ...
            cur = build_attn(inp_attn_cross, model.layers[il].wo_cross, nullptr, Qcur, Kcur, Vcur, nullptr, nullptr,
                             nullptr, 1.0f, il);
            cb(cur, "kqv_out", il);
        ...
        // feed-forward network
        {
            ...
            cur = build_ffn(cur, model.layers[il].ffn_up, NULL, NULL, model.layers[il].ffn_gate, NULL, NULL,
                            ...
                            model.layers[il].ffn_gate ? LLM_FFN_PAR : LLM_FFN_SEQ, il);
            cb(cur, "ffn_out", il);
        }
