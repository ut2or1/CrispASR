...
std::pair<ggml_tensor*, ggml_tensor*> llm_build_qwen35::build_qkvz(ggml_tensor* input, int il) {
...
ggml_tensor* llm_build_qwen35::build_norm_gated(ggml_tensor* input, ggml_tensor* weights, ggml_tensor* gate,
                                                int layer) {
...
ggml_tensor* llm_build_qwen35::build_layer_attn(llm_graph_input_attn_kv* inp, ggml_tensor* cur, ggml_tensor* inp_pos,
                                                int* sections, int il) {
    const int64_t n_embd_head = hparams.n_embd_head_v();
    GGML_ASSERT(n_embd_head == hparams.n_embd_head_k());
...
ggml_tensor* llm_build_qwen35::build_layer_attn_linear(llm_graph_input_rs* inp, ggml_tensor* cur, int il) {
