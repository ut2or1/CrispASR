...
llm_build_mimo2_iswa::llm_build_mimo2_iswa(const llama_model& model, const llm_graph_params& params)
    ...
    for (int il = 0; il < n_layer; ++il) {
        ...
        // self_attention
        {
            ...
            cur = build_attn(inp_attn, model.layers[il].wo, NULL, Qcur, Kcur, Vcur, nullptr, sinks, nullptr,
        ...
        if (model.layers[il].ffn_gate_inp == nullptr) {
            ...
            cur = build_moe_ffn(cur, model.layers[il].ffn_gate_inp, model.layers[il].ffn_up_exps,
                                ...
                                model.layers[il].ffn_exp_probs_b, n_expert, n_expert_used, LLM_FFN_SILU, true,
                                hparams.expert_weights_scale, LLAMA_EXPERT_GATING_FUNC_TYPE_SIGMOID, il);
